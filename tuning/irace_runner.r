...
## algorithm.
parameterFile <- file.path(".", algorithm, "parameters.txt")
...
trainInstancesDir <- file.path("..", "data", "instances", instance_size)
...
targetRunner <- file.path(".", "target-runner.sh")
...
callScript <- file.path(".", algorithm, paste0(algorithm, "_caller.jl"))
targetCmdline <- paste0(
  callScript,
